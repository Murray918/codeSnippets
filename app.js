...
const express = require('express'),
      ...
      loginMustache = require('./loginCreds/login.js'),
      app = express(),
      path = require('path'),
      credentials = require('./loginCreds/login.js'),
      mongoose = require('mongoose'),
      loginProofer = credentials.loginProofer,
      loginCreator = credentials.loginCreator,
      CodeSchema = require('./models/model.js'),
...
app.get('/showall/', (req, res, next) => {
	req.session.login = true;
	CodeSchema.find().then(viewSnippets => {
		res.render('home', {
